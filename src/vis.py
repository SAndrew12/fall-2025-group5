...
# ============================================================================
# FEATURE FUSION VISUALIZATION FUNCTION - NEW!
# ============================================================================

def generate_fusion_plots(fusion_model, X_text_test, X_features_test, y_test,
                          model_name='Feature Fusion', save_dir=SAVE_DIR):
    """
    Generate all plots for Feature Fusion model (BERT + manual features)

    Args:
        fusion_model: Trained BERTFeatureFusionClassifier instance
        X_text_test: Test texts
        X_features_test: Test manual features (DataFrame or numpy array)
        y_test: Test labels
        model_name: Name to display on plots
        save_dir: Directory to save plots
    ...
    # Get predictions - KEY FIX: Feature Fusion needs BOTH text and features
    y_pred = fusion_model.predict(X_text_test, X_features_test)
    y_proba = fusion_model.predict_proba(X_text_test, X_features_test)
